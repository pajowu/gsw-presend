![Germany Says Welcome](images/gsw.png)<!-- .element: width="25%" -->
...
<p><img src="images/current-team-small.jpg" alt="Das Team" style="height: 650px;overflow: hidden;"></p>
...
![code](images/jugendhackt-small.jpg)
<p style="font-style:italic;align:bottom;position:absolute;right:0;bottom:0;font-size:small;">
...
<p><img src="images/okfn.svg"></p>
Note: JH is organised by th Open Knowledge Foundation Germany

----

![code](images/frank-rieger-small.jpg)
<p style="font-style:italic;align:bottom;position:absolute;right:0;bottom:0;font-size:small;">
...
![code](images/brainstorming-small.jpg)
<p style="font-style:italic;align:bottom;position:absolute;right:0;bottom:0;font-size:small;">
...
![create](images/create-small.jpg)
<p style="font-style:italic;align:bottom;position:absolute;right:0;bottom:0;font-size:small;">
...
![hating the computer](images/anna-small.jpg)
<p style="font-style:italic;align:bottom;position:absolute;right:0;bottom:0;font-size:small;">
...
![Social](images/social-small.jpg)
<p style="font-style:italic;align:bottom;position:absolute;right:0;bottom:0;font-size:small;">
...
![HTML5](images/html.svg) <!-- .element: width="50%" -->

----

![React](images/react_logo.svg) <!-- .element: width="25%" -->
![Flux](images/flux_logo.svg) <!-- .element: width="25%" -->
...
![Choose Language](images/app-chooselang-small.jpg) <!-- .element: width="35%" -->

----

![Choose Step](images/app-choosestep-small.jpg)<!-- .element: width="35%" -->

----

![Dashboard](images/app-dashboard-small.jpg)<!-- .element: width="35%" -->

----

![FAQ](images/app-faq-small.jpg)<!-- .element: width="35%" -->

----

![Emergency](images/app-emergency-small.jpg)<!-- .element: width="35%" -->

---

## Admin Panel

![Admin Panel](images/wordpress.svg) <!-- .element: width="100%" -->
